import{i as e}from"./preload-helper-xPQekRTU.js";import{n as t,t as n}from"./KcPageStory-YOO-k3qL.js";var r,i,a,o,s,c;e((()=>{t(),{KcPageStory:r}=n({pageId:`login-oauth2-device-verify-user-code.ftl`}),i={title:`login/login-oauth2-device-verify-user-code.ftl`,component:r},a={},o={args:{kcContext:{url:{oauth2DeviceVerificationAction:`/mock-oauth2-device-verification`},message:{summary:`The user code you entered is invalid. Please try again.`,type:`error`}}}},s={args:{kcContext:{url:{oauth2DeviceVerificationAction:`/mock-oauth2-device-verification`},message:{summary:`User code cannot be empty. Please enter a valid code.`,type:`error`}}}},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{}`,...a.parameters?.docs?.source}}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    kcContext: {
      url: {
...
- Key Aspect: Ensures the form displays validation errors when the field is left empty.`,...s.parameters?.docs?.description}}},c=[`Default`,`WithErrorMessage`,`WithEmptyInputField`]}))();export{a as Default,s as WithEmptyInputField,o as WithErrorMessage,c as __namedExportsOrder,i as default};