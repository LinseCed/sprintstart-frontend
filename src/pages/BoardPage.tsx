        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6">
            <header className="mb-6 flex flex-wrap items-start justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-bold leading-tight text-app-text">Board</h1>
            ...
            {!selectedProjectId && !projectsLoading ? (
                <p className="rounded-2xl border border-app-border bg-app-surface p-6 text-sm text-app-text-muted">
                    You&apos;re not on a project yet, so there&apos;s nothing to put on a board.
                    Whoever set up your account can add you to one.
                </p>
            ) : loading ? (
