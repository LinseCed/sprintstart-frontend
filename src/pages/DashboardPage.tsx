            ...
            <main className="app-page-frame flex min-h-[70vh] flex-col p-8">
                ...
                <div className="flex flex-1 flex-col items-center justify-center space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl mt-8">
                        ...
                        <Link to="/buddy" className="flex flex-col items-center justify-center p-8 bg-app-surface border border-app-border rounded-2xl hover:border-app-accent hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
