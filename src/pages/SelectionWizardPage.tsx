        ...
        <div className="relative w-full max-w-[520px] overflow-hidden rounded-[28px] border border-app-border bg-app-bg p-7 shadow-2xl">
          ...
          {step === 1 && (
              <div className="relative z-10">
                ...
                <p className="mb-5 text-xs text-app-text-muted">
                    ...
                    return (
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="text-[10px] leading-relaxed text-app-text-muted">
                              {role.description}
                            </div>
                          </div>
          ...
          <div className="relative z-10 mt-6 flex items-center justify-between gap-3">
            {step === 2 ? (
                <button
                    type="button"
                    onClick={() => setStep(1)}
                    className="rounded-lg px-1 py-2 text-xs font-medium text-app-text-muted transition-colors hover:text-app-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-focus"
                >
                  ← Back
                </button>
            ) : (
