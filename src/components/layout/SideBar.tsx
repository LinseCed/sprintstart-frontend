...
const navItems: SidebarNavItem[] = [
  {
    ...
    path: "/",
    icon: (
      <ChartColumn className="h-[18px] w-[18px] shrink-0 transition-colors" />
    ),
  },
  {
    label: "Chat",
    path: "/chat",
    icon: (
      <MessageSquare className="h-[18px] w-[18px] shrink-0 transition-colors" />
    ),
  },
  {
...
const projectManagerNavItems: SidebarNavItem[] = [
  {
    ...
    path: "/pm-dashboard",
    icon: (
      <Briefcase className="h-[18px] w-[18px] shrink-0 transition-colors" />
    ),
  },
  {
