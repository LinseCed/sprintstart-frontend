 ...
 *
 * ⚠️ **This is a second way to add work, not a filter in front of mining.** Mining keeps landing
    ...
    return (
        ...
        >
            ...
            <p className="mb-4 text-xs text-app-text-muted">
                Every open issue the project has ingested. Adding one puts it in the pool straight
                away — the same as writing a task by hand, because you looked at it. Mining keeps
                filling the pool on its own; this is a second way in, not a gate in front of it.
            </p>
            ...
            {!projectId ? (
                ...
                <>
                    <div className="mb-3 flex flex-wrap items-center gap-3">
                        ...
                        {/* ⚠️ Off by default, and it hides only the issues somebody is definitely on.
    ...
    return (
        ...
        >
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
                {/* ⚠️ Only a definite `true` is marked. Null means SprintStart does not know — it
