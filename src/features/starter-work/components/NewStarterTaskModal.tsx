            ...
            >
                <div className="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-app-text-muted">
                            Author a first task by hand. The AI is optional — this becomes a goal a
                            hire can aim at right away, no mining needed.
                        </p>
                    </div>
                    <button
                        type="button"
                ...
                <div>
                    ...
                    >
                        ...
                        <span className="text-app-text-subtle">(optional)</span>
                    </label>
                    <input
