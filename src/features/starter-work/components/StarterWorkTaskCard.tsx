 ...
 */
export function StarterWorkTaskCard({ task, canAct, onApprove, onReject }: StarterWorkTaskCardProps) {
        ...
        <article className="rounded-2xl border border-app-border bg-app-surface p-4">
            <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                    ...
                    {task.summary && (
                        <p className="mt-1 text-sm text-app-text-muted">{task.summary}</p>
                    )}
                </div>
                {task.sourceUrl && (
                    <a
