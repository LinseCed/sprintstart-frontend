...
export function TokensSection() {
    ...
    const showLoading = !tokensLoaded && isRefreshing;
    ...
    return (
        <div className="space-y-4">
            ...
            {!showLoading && tokensError && (
                <div className="rounded-xl border border-app-danger-border bg-app-danger-bg px-4 py-3 text-sm text-app-danger-text">
                    {tokensError}
                </div>
            )}
                    ...
                    {isAddOpen && (
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <div>
                                    <label htmlFor="settings-add-token-name" className="mb-1.5 block text-xs font-medium text-app-text-muted">
                                        Token name
                                    </label>
                                    <input
                                ...
                                <div>
                                    <label htmlFor="settings-add-token-value" className="mb-1.5 block text-xs font-medium text-app-text-muted">
                                        Token (ghp_...)
                                    </label>
                                    <input
                                        ...
                                        {rotatingName === name && (
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col gap-3 xl:flex-row xl:items-end">
                                                    <div className="min-w-0 flex-1">
                                                        <label htmlFor="settings-rotate-token-value" className="mb-1.5 block text-xs font-medium text-app-text-muted">
                                                            New GitHub PAT
                                                        </label>
