    ...
    return (
        ...
        <div className="shrink-0 px-4 pt-4">
            ...
            >
                {answered.length > 0 && (
                    <>
                        <h2 className="mb-2 text-xs font-medium uppercase tracking-wide text-app-text-muted">
                        ...
                        <ul className="space-y-3">
                            {answered.map(request => (
                                <li key={request.id}>
                                    ...
                                    <p className="mt-1.5 whitespace-pre-wrap pl-6 text-sm text-app-text-muted">
                ...
                {waiting.length > 0 && (
                    <>
                        <h2
                            className={`mb-2 text-xs font-medium uppercase tracking-wide text-app-text-muted ${
