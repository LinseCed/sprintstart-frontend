    ...
    if (!isOpen) {
        return (
            <button
                ...
                className="flex items-center gap-1.5 text-sm text-app-text-muted transition-colors hover:text-app-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-focus"
            >
