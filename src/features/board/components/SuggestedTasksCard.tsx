        ...
        >
            {content.tasks.length === 0 ? (
                <p className="text-sm text-app-text-muted">
                    No starter tasks are ready for you yet. Your PM approves the ones that fit your
                    role — ask your buddy if you want something to get started on in the meantime.
                </p>
            ) : (
