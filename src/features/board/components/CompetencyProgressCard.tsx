        ...
        >
            {nothingYet ? (
                <p className="text-sm text-app-text-muted">
                    Nothing on your record yet. That&apos;s the normal shape of a first week — it
                    fills in as work of yours is accepted.
                </p>
            ) : (
                <div className="space-y-3">
                    {held.length > 0 && (
                        <div>
                            <p className="mb-1 text-xs font-medium uppercase tracking-wide text-app-text-muted">
                                Shown
                            </p>
