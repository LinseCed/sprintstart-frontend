        ...
        >
            {attributionMissing ? (
                <p className="text-sm text-app-text-muted">
                    No GitHub username on your profile yet, so I can&apos;t tell which pull requests
                    are yours. Add it on your profile and this fills itself in.
                </p>
            ) : pullRequests.length === 0 ? (
                <p className="text-sm text-app-text-muted">
                    Nothing open right now. When you open one it shows up here, with how long it has
                    been waiting.
                </p>
            ) : (
