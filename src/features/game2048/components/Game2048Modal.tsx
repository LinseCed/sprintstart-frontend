                    ...
                    >
                        ...
                        <div className="flex items-center justify-between border-b border-app-border px-4 py-3">
                            ...
                            <button
                                ...
                                className="flex h-8 w-8 items-center justify-center rounded-lg text-app-text-muted transition-colors hover:bg-app-surface-hover hover:text-app-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-focus"
                            >
                                <X size={20} />
                            </button>
                        </div>
