    ...
    if (isSent) {
        return (
            ...
            >
                ...
                <span>
                    Thanks — your PM can see this. The guide above is unchanged; nothing you read has
                    moved.
                </span>
            </p>
        );
    ...
    if (!isOpen) {
        return (
            <button
                ...
                className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-app-text-muted transition-colors hover:text-app-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-focus"
            >
    ...
    return (
        <div className="mt-3 min-w-0 rounded-lg border border-app-border bg-app-surface p-3">
            ...
            <textarea
                ...
                className="w-full rounded-lg border border-app-border bg-app-bg px-3 py-2 text-sm text-app-text transition-colors focus:border-app-brand focus:outline-none focus:ring-1 focus:ring-app-brand"
            />
            {error && (
            ...
            <div className="mt-2 flex items-center gap-2">
                ...
                <button
                    ...
                    className="text-xs font-medium text-app-text-muted hover:text-app-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-focus"
                >
                    Cancel
                </button>
            </div>
