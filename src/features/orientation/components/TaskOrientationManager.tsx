...
export function TaskOrientationManager() {
    ...
    const [editing, setEditing] = useState<{ task: StarterWorkTask; orientation: MyOrientation } | null>(null);
        ...
        >
            ...
            {editing && selectedProjectId && (
                <OrientationEditor
                    ...
                    onSave={async input => {
                        await orientationService.authorTaskOrientation(editing.task.id, selectedProjectId, input);
                        return true;
                    }}
                    onRevert={
                        editing.orientation.packet
                            ? async () => {
                                  await orientationService.revertTaskOrientation(editing.task.id, selectedProjectId);
                                  return true;
                              }
                            : undefined
                    }
