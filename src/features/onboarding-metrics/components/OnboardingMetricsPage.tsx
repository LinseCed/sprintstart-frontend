 ...
 * percentages, no module counts, because those are the metrics the redesign
 * rejects. Metrics are per-project (onboarding is per-project), so a switcher
                            ...
                            {stalledHires.length > 0 ? (
                                <>
                                    <div className="mb-3 flex items-center gap-2">
                                        <AlertTriangle
                                            className="h-5 w-5 text-app-warning-solid"
                                            aria-hidden="true"
                                        />
                                    ...
                                    <p className="mb-4 text-sm text-app-text-muted">
                                        The thing to act on today. Where the wait is on a review, the
                                        fix is a conversation with the reviewer — not a nudge to the
                                        hire.
                                    </p>
                                ...
                                <div className="flex items-center gap-2">
                                    <CheckCircle2
                                        className="h-5 w-5 text-app-success-solid"
                                        aria-hidden="true"
                                    />
