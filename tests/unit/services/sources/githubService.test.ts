...
describe('githubService', () => {
    ...
    describe('connectGithubRepository', () => {
        it('POSTs owner, name and tokenName and returns the transaction id', async () => {
            ...
            expect(capturedBody).toEqual({ owner: 'octocat', name: 'Hello-World', tokenName: 'default', projectId: 'p1' });
        ...
        it('rejects when the backend returns a non-OK response', async () => {
            ...
            await expect(
                connectGithubRepository({ owner: 'o', name: 'n', tokenName: 't', projectId: 'p1' }),
