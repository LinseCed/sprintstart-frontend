    ...
    sections: [
        {
            ...
            body: 'Run make dev.',
            citations: [{ filename: 'README.md', chunkId: 'c1', sourceUrl: 'https://example.test/README.md' }]
        }
    ],
    sources: [{ filename: 'README.md', sourceUrl: 'https://example.test/README.md', artifactType: 'FILE' }],
...
describe('OrientationEditor', () => {
    ...
    it('cannot save until a section has a title and a body', async () => {
        ...
        render(
            <OrientationEditor taskTitle="A task" taskUrl={null} initial={null} onSave={onSave} onClose={vi.fn()} />
        );
    ...
    it('reuses the hire renderer so the preview cannot drift from what ships', async () => {
        ...
        render(
            <OrientationEditor taskTitle="A task" taskUrl={null} initial={null} onSave={vi.fn()} onClose={vi.fn()} />
        );
