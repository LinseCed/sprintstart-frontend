...
describe('ChatSection — Thought Process toggle', () => {
    ...
    it('defaults to on (checked)', () => {
        ...
        expect(screen.getByTestId('chat-thought-process-toggle')).toHaveAttribute('aria-checked', 'true');
    });
    ...
    it('persists the preference to localStorage when toggled off', async () => {
        ...
        expect(screen.getByTestId('chat-thought-process-toggle')).toHaveAttribute('aria-checked', 'false');
